...
const WelcomeScreen = () => {
    ...
    const handleDoctorCreated = (newDoctorData) => {
        ...
        alert(`Doctor ${newDoctorData.name} created successfully! (Check console for data)`);
        setShowCreateDoctorModal(false);
        ...
        switch (activeItem) {
                ...
                return (
                    <>
                        <p className={styles.rightContentText}>
                            Begin by setting up practitioner profiles add names, roles, and schedules to seamlessly manage
                            your teams information and availability.
                        </p>
            ...
            case 'doctor':
                return (
                    <>
                        <p className={styles.rightContentText}>
                            Manage your doctors information, including their specialties, contact details, and schedules.
                        </p>
                        <button className={styles.createButton} onClick={handleCreateDoctorClick}>
            ...
            case 'procedure':
                return (
                    <>
                        <p className={styles.rightContentText}>
                            Define and manage all dental procedures offered, including costs and descriptions.
                        </p>
                        <button className={styles.createButton} onClick={handleCreateProcedureClick}>
            ...
            case 'lab':
                return (
                    <>
                        ...
                        <button className={styles.createButton} onClick={handleCreateLabClick}> {/* NEW: onClick for Lab */}
        ...
        <div className={styles.container}>
            ...
            <div className={styles.contentArea}>
                <div className={styles.learnTheBasics}>
                    <svg className={styles.bookIcon} viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className={styles.mainContent}>
                    <div className={styles.sidebar}>
                        <button
                            className={`${styles.sidebarButton} ${activeItem === 'profile' ? styles.active : ''}`}
                        ...
                        <button
                            className={`${styles.sidebarButton} ${activeItem === 'doctor' ? styles.active : ''}`}
                        ...
                        <button
                            className={`${styles.sidebarButton} ${activeItem === 'procedure' ? styles.active : ''}`}
                        ...
                        <button
                            className={`${styles.sidebarButton} ${activeItem === 'lab' ? styles.active : ''}`}
                        ...
                        <button
                            className={`${styles.sidebarButton} ${activeItem === 'drug' ? styles.active : ''}`}
