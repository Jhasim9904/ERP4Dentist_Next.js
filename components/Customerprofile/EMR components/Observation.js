  ...
  return (
    <div className="observation-container">
      ...
      {data.length === 0 ? (
        ...
        data.map((obs, index) => (
          <div key={index} className="observation-section">
            <div className="observation-header">
              <div className="observation-info">
                <p>
                  <strong>Examination Date:</strong>{" "}
                  <span className="dim-text">{obs.startDate}</span>
                </p>
                <p>
                  <strong>Chief Complaint:</strong>{" "}
                  <span className="dim-text">{obs.observation}</span>
                </p>
                <p>
                  <strong>Occlusion:</strong>{" "}
                  <span className="dim-text">{obs.occlusion || "-"}</span>
                </p>
                <p>
                ...
                <p>
                  ...
                  <span className="dim-text">{obs.calculus || "++"}</span>
                  <span style={{ marginLeft: "3rem" }}>
                    <strong>Stains:</strong>{" "}
                    <span className="dim-text">{obs.stains || "++"}</span>
                  </span>
                </p>
              </div>
              ...
              <div className="observation-actions">
                <p>
                  Doctor: <strong>{obs.doctor}</strong>
                </p>
